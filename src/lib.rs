...
#[derive(Debug)]
pub struct InfuraAPIProcessor {
    verbose: bool,
    processed_count: usize,
}

impl InfuraAPIProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting InfuraAPI processing");
    
    let mut processor = InfuraAPIProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = InfuraAPIProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = InfuraAPIProcessor::new(false);
